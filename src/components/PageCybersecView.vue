<script setup></script>
<template>
    <section class="section-file kv cybersec">
        <div class="bg"></div>
    ...
    <section class="section-file list cybersec">
        <div class="container">
                    ...
                    <div class="tab-content file-tab-content">
                        <div class="tab-pane content2022 fade" id="tabContent2022" role="tabpanel"
                            ...
                            <div class="row tab-row">
                                ...
                                <div class="col-10 tabAnswer">
                                    2021/10 - 2021/12 call for speaker 徵稿網頁
                                    <br>2021/11 - 2022/2 第一版宣傳網站上線
                                    <br>2022/2 - 2022/4 每週更新上線
                                    <br>2022/4 - 2022/5 會前資訊上線
                                    <br>2022/5 - 2022/6 會後資訊上線
                                </div>
                            </div>
                            <div class="row tab-row">
                            ...
                            <div class="row tab-row">
                                ...
                                <div class="col-10 tabAnswer">主管、PM、活動統籌、設計總監、前端設計、前端工程師、後端工程師</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">專案背景</div>
                                <div class="col-10 tabAnswer">延續前幾年已成功打響名聲的資安大會，並有前幾年固定版面、架構的資訊型態網站可依循</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">目標</div>
                                <div class="col-10 tabAnswer">延續去年網站架構，將過往過於複雜資訊在做分類精簡，著重 navbar，並在各階段，如期上線。
                                </div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">流程 </div>
                                <div class="col-10 tabAnswer"> 
                                    <ol>
                                        <li>主管、PM、活動統籌，共同規劃：整合網站架構。PM 畫設計稿與各部門溝通。</li>
                                        <li>設計總監規劃 VI 視覺設計規範。</li>
                                        <li>前端設計接續 1. 調整成適合網頁設計的版面、切版、研究動畫效果，中途帶入 2. 的主視覺與風格。</li>
                                        <li>後端提供後台資料 api。</li>
                                        <li>前端工程師建立 NUXT 環境、套版、接api，依序上線。</li>
                                        <li>資安測試</li>
                                        <li>滾動式更新版面</li>
                                    </ol>
                                </div>
                        ...
                        <div class="tab-pane fade" id="tabContent2021" role="tabpanel" aria-labelledby="tabContent2021">
                            ...
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">時間</div>
                                <div class="col-10 tabAnswer">
                                    2020/11 call for speaker 徵稿網頁
                                    <!-- <br>2021/12 - 2022/1 原訂第一版宣傳網站上線，因疫情推遲
                                    <br>2022/2 第一版宣傳網站上線，開始報名
                                    <br>2022/2 - 2022/3 每二週更新ㄧ版
                                    <br>2022/3 - 2022/4 會前資訊上線
                                    <br>2022/5 - 2022/6 會後資訊上線 -->
                                </div>
                            </div>
                            <div class="row tab-row">
                            ...
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">專案背景</div>
                                <div class="col-10 tabAnswer">延續去年已成功打響名聲的資安大會，並有前2年固定版面、架構，今年重新整合網站資訊，並加入更多活動、典禮，首頁新增熱門焦點</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">目標</div>
                                <div class="col-10 tabAnswer">延續去年網站架構，將過往過於複雜資訊在做分類精簡，著重 navbar，並在各階段，如期上線。
                            ...
                            <div class="row tab-row">
                                ...
                                <div class="col-10 tabAnswer"> 
                                    <ol>
                                        <li>主管規劃整合網站架構，畫設計稿。</li>
                                        <li>主管、活動統籌、PM ，各部門溝通</li>
                                        <li>設計總監規劃 VI 視覺設計規範。</li>
                                        <li>前端設計接續 1. 調整成適合網頁設計的版面、切版， 中途帶入 3.的主視覺與風格。</li>
                                        <li>後端建立後台上稿系統。提供後台資料 api。</li>
                                        <li>前端工程師建立 NUXT 環境、套版、接api，依序上線。</li>
                                        <li>資安測試</li>
                                        <li>滾動式更新版面</li>
                                    </ol>
...
<img src="./../assets/img/files/cyber2021_01.jpg" alt="" class="img"loading="lazy">
                                ...
                                <img src="./../assets/img/files/cyber2021_05.jpg" alt="" class="img"loading="lazy">
                                <img src="./../assets/img/files/cyber2021_06.jpg" alt="" class="img"loading="lazy">
                        ...
                        <div class="tab-pane fade" id="tabContent2020" role="tabpanel" aria-labelledby="tabContent2020">
                            ...
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">團隊成員</div>
                                <div class="col-10 tabAnswer">主管、活動統籌、設計總監、前端設計、前端工程師、後端工程師</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">專案背景</div>
                                <div class="col-10 tabAnswer">今年重點在地點變更，以及資安大會、資安大展會眾分不清，其次是官網資訊架構混亂，不熟悉會迷路的網站</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">目標</div>
                                <div class="col-10 tabAnswer">共識是成為資訊型活動網站，以去年網站架構，今年重點在地點變更！滾動式更新。
                                </div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">流程 </div>
                                <div class="col-10 tabAnswer"> 
                                    <ol>
                                        <li>主管規劃整合網站架構，畫設計稿。</li>
                                        <li>主管、活動統籌、PM ，各部門溝通</li>
                                        <li>設計總監規劃 VI 視覺設計規範，並提供各主管認可之網站 kv，每年需有全新設計視野。</li>
                                        <li>前端設計接續 1. 調整成適合網頁設計的版面、切版， 中途帶入 3.的主視覺與風格，並延伸 kv。</li>
                                        <li>後端建立後台上稿系統。提供後台資料 api。</li>
                                        <li>前端工程師建立 NUXT 環境、套版、接api，依序上線。</li>
                                        <!-- <li>資安測試</li> -->
                                        <li>滾動式更新版面</li>
...
<img src="./../assets/img/files/cyber2020_01.jpg" alt="" class="img"loading="lazy">
                                ...
                                <img src="./../assets/img/files/cyber2020_05.jpg" alt="" class="img"loading="lazy">
                                <img src="./../assets/img/files/cyber2020_06.jpg" alt="" class="img"loading="lazy">
                                <img src="./../assets/img/files/cyber2020_07.jpg" alt="" class="img"loading="lazy">
                        ...
                        <div class="tab-pane fade show active" id="tabContent2019" role="tabpanel" aria-labelledby="tabContent2019">
                            ...
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">時間</div>
                                <div class="col-10 tabAnswer">
                                    2018/12 - 2019/2 宣傳版網站上線
                                    <br>2019/2 - 2019/3 完整版網站上線
                                    <br>2019/4 會後網站調整上線
                                </div>
                            </div>
                            <!-- <div class="row tab-row">
                            ...
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">團隊成員</div>
                                <div class="col-10 tabAnswer">社長、主管、網開部經理、企服部經理、活動統籌、設計總監、前端設計、前端工程師</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">專案背景</div>
                                <div class="col-10 tabAnswer">官網資訊架構混亂，高層長期開會也未有定案，屬於成長中的活動，所有架構規劃都在主管腦中，需經由主管畫出藍圖，並符合社長希望的大氣、豐富感。</div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">目標</div>
                                <div class="col-10 tabAnswer">因為還不理解該案的所有資訊和作業方式，只能見招拆招。評估主管畫的設計稿，並調整成可製作成網站的設計稿做溝通（首頁）！網站上不清楚的就請清楚的人提供資源（如照片篩選），字型大小是主管在意點之一。保守切版、滾動式更新。
                                </div>
                            </div>
                            <div class="row tab-row">
                                <div class="col-2 tabLabel">流程 </div>
                                <div class="col-10 tabAnswer"> 
                                    <ol>
                                        <li>主管規劃整合網站架構，畫設計稿。</li>
                                        <li>社長、主管、網開部經理、企服部經理、活動統籌、設計總監、前端設計，各部門溝通</li>
                                        <li>設計總監規劃平面設計視覺，並提供各長官認可之網站形象kv（每年需有全新設計視野）。</li>
                                        <li>前端設計接續 1. 調整成適合網頁設計的版面、切版， 中途帶入 3.的主視覺與風格，並延伸 kv。</li>
                                        <li>前端工程師建立 NUXT 環境、套版、接api，依序上線。</li>
                                        <li>滾動式更新版面</li>
                                    </ol>
...
<img src="./../assets/img/files/cyber2019_01.jpg" alt="" class="img"loading="lazy">
                                ...
                                <img src="./../assets/img/files/cyber2019_05.jpg" alt="" class="img"loading="lazy">
